-- Slag Light — generated from palette.mjs, do not edit by hand.
--
-- Install:
--   cp slag-light.lua ~/.config/nvim/colors/
--   :colorscheme slag-light
...
vim.g.terminal_color_15 = "#c4c4c4"
